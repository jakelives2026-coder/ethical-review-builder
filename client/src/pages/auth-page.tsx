...
export default function AuthPage() {
  ...
  // Read tab parameter from URL search params and handle OAuth errors
  useEffect(() => {
    ...
    if (error === "oauth") {
      toast({
        ...
        description: "Google sign-in failed. Please try again or use email and password.",
        variant: "destructive",
      });
    }
  }, [toast]);
              ...
              <Card className="shadow-lg">
                ...
                <CardContent className="space-y-4">
                  ...
                  <a
                    ...
                    className="w-full h-11 border border-border rounded-md bg-white hover:bg-gray-50 flex items-center justify-center gap-2 font-medium text-neutral-800 transition duration-200"
                  >
